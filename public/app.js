...
var gameplay10 = new Phaser.Class({
...
//		socket.on('paix', function () {
//			console.log(this);
//			addNewPlayer(gameplay)
//		});



  //console.log(game.gameplay.socket.id);

//   socket.on('paix', function (message) { 
// 		console.log("amour " + message);
// 	});
